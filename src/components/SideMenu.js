...
export const menuItems = [
...

  {
    ...
    subMenus: [
      ...
      { name: "Video", to: "/hub/Events" },
      { name: "Achivements", to: "/hub/Events" },
      { name: "Manage Logo", to: "/hub/Events" },
      { name: "Manage Banner", to: "/hub/Events" },
      { name: "Whats New", to: "/hub/Events" },
      { name: "Feedback", to: "/hub/Events" },
    ],
  },
  {
    name: "Employee",
