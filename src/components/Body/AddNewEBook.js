    ...
    <>
      <form action="">
        <div class="magazin-container">
          <h3 className="magazin-heading"><i class="bi bi-house-door design_icon"></i> Add New EBook</h3>
          <hr />
          <label for="MagazineName">
            <p className="design_das_p">Book Name</p>
          </label>
          <input
            type="text"
            placeholder=""
        ...
        <div class="form-group">
          ...
          <hr />
          <label for="PrimaryCategory"><p className="design_das_p">Primary Category</p></label>
          <div class="form-group">
            <select name="country" className="input_box">
                <option value="australia">Select</option>
                <option value="australia">Select</option>
